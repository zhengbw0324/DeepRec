...
class PPOTrainer(ABC):
    ...
    def ppo_train(self, global_steps=0):
        ...
        #TODO: kill
        if global_steps > self.strategy.args.max_global_steps:
            raise RuntimeError(f"stop when step > {self.strategy.args.max_global_steps}")
    ...
    def training_step_actor(self, experience: Experience) -> Dict[str, float]:
        ...
        if isinstance(experience.sequences, list):
            ...
            item_mask = torch.cat(experience.item_mask, dim=0).unsqueeze(0)
        ...
        if self.args.use_kl_loss:
            ...
            if not self.args.packing_samples:
                ...
                for i, each_kl in enumerate(kl):
                    kl_mean[i] = masked_mean(each_kl, experience.action_mask,item_mask=item_mask[i], dim=-1,)
    ...
    def training_step_critic(self, experience: Experience) -> Dict[str, float]:
        ...
        status = {
            ...
            "values": masked_mean(values, experience.action_mask, experience.item_mask).item(),
